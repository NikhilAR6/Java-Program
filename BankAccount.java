...
public class BankAccount {
	...
	float balance;
	public BankAccount(int accNo, String customername, String acctype, float balance) throws NegativeAmountException, LowBalanceException {
		super();
		this.accNo = accNo;
...
//			}
	...
	public void withdraw(float amt) throws LowBalanceException, NegativeAmountException {
	...
	public static void main(String[] args)
	{
		try {
			...
			//BankAccount ba=new BankAccount(1001,"Raju","Saving",8875);
			ba.deposit(1110);
